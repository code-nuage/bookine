...
class LoanModel extends SqlConnect {
    private $table = "books";
    public $authorized_fields_to_update = ["title", "author"];

    public function create(array $data) {
        $query = "
        INSERT INTO $this->table (isbn, title, author, publish_date, category)
        VALUES (:isbn, :title, :author, :publish_date, :category)
      ";
